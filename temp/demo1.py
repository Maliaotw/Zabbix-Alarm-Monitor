...
class Frame1(wx.Frame):
    def __init__(self, parent):
        ...
        tChoiceEditor = wx.grid.GridCellChoiceEditor(['spam','eggs'], allowOthers=False)
        ...
        self.grid1.SetCellValue(0, 0, self.grid1.list[0])
        self.grid1.SetCellValue(0, 1, self.grid1.list[1])
